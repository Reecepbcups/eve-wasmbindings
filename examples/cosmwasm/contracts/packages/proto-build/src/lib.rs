...
const OUT_DIR: &str = "/home/reece/Desktop/Programming/Go/osmosis-rust/packages/eve-std/src/types/";
/// Directory where the cosmos-sdk submodule is located
// const COSMOS_SDK_DIR: &str = "../../dependencies/cosmos-sdk/";
const COSMOS_SDK_DIR: &str = "/home/reece/Desktop/Programming/Go/osmosis-rust/dependencies/cosmos-sdk/";
/// Directory where the osmosis submodule is located
// const OSMOSIS_DIR: &str = "/home/reece/Desktop/Programming/Go/osmosis-rust/dependencies/osmosis/";
const EVE_DIR: &str = "/home/reece/Desktop/Programming/Go/osmosis-rust/dependencies/eve/";
...
pub fn run() {
    ...
    let eve_project = CosmosProject {
        name: "eve".to_string(),
        version: OSMOSIS_REV.to_string(),
        project_dir: EVE_DIR.to_string(),
    };
    ...
    let eve_code_generator = CodeGenerator::new(
        out_dir.clone(),
        tmp_build_dir.clone(),
        eve_project,
        vec![cosmos_project],
